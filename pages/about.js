		     		...
		     		<div className="static-trend-list">
		     				 <div className="inner" id="about-content-sections">
							   ...
							   <div className="content">
								...
								<p>In my youth, I immersed myself in a profound love for the game of Go, often tinkering with the board in my leisure time. Once, I harbored the dream of becoming a skilled Go player; however, I knew nothing about the learning path to achieve this dream. I was unaware of how to become a professional Go player, and ultimately, this dream silently faded away.</p>
								...
								<p>We build that in a hope to assist those who harbor dreams but lack guidance through this app, providing help and support.</p>
										    </div>
							   </div>
					</div>
			</div>
