...
let prompts_user =[];
	prompts_user.push("Please briefly introduce "+sport+" and the benefit of participating in this activity.  ");
	prompts_user.push("please provide training activities by level or by age, also indication the key milestones.");
	prompts_user.push("please provide key competitions by level or by age for kids  and provide the link, plus briefly description");
   ...
   let Pagebody =
	...
	return (<div className="wrapper">
					<div id="main">
						<div className="inner">
							<header>
								<h1>Inspiring Tomorrow's _____ Today.</h1>
								<p> We believe that every child deserves the opportunity to 
								discover the joy of sports, arts activites. Our mission is to make activites 
								accessible, engaging, and educational for kids of all ages. 
								Whether your child is a budding athlete or just starting to 
								explore the world of sports, arts, we're here to inspire and 
								empower them on their journey. </p>
							</header>
							<hr/>
						</div>
						<div className="inner">
